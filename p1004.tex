...
\cc{std::pointer_traits} can be made \cc{constexpr}; this is handled by
P1006, which should be published in the same mailing as this paper.
...
namespace std {
  ...
  template<class InputIterator,
    ...
    @\added{constexpr}@ vector(InputIterator, InputIterator, Allocator = Allocator())
