...
> some (possibly dependent) type `T`. This parameter is the _type-identity parameter_. The
...
> type-identity parameter is of type `std::type_identity<T>` where `T` shall be a dependent
