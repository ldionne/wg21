...
>
> [5.1]{.pnum} If `extent` is not equal to `dynamic_extent`, `count == extent`.
:::
>
...
>
> [9.1]{.pnum} If `extent` is not equal to `dynamic_extent`, `(last - first) == extent`.
:::
>
...
>
> [16.1]{.pnum} If `extent` is not equal to `dynamic_extent`, `ranges::size(r) == extent`.
:::
