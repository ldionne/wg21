...
>
:::add
> [5]{.pnum} _Hardened preconditions_:
>
> [5.1]{.pnum} - If `extent` is not equal to `dynamic_extent`, then `count` is equal to `extent`.
:::
>
...
>
:::add
> [9]{.pnum} _Hardened preconditions_:
>
> [9.1]{.pnum} - If `extent` is not equal to `dynamic_extent`, then `last - first` is equal to `extent`.
:::
>
...
>
:::add
> [16]{.pnum} _Hardened preconditions_:
>
> [16.1]{.pnum} - If `extent` is not equal to `dynamic_extent`, then `ranges::size(r)` is equal to `extent`.
:::
...
>
> [19]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: If `extent` is not equal to `dynamic_extent`, then `il.size()` is equal to `extent`.
>
...
>
> [23]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: If `extent` is not equal to `dynamic_extent`, then `s.size()` is equal to `extent`.
>
...
>
> [1]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `pos < size()`.
>
> [2]{.pnum} _Returns_: `data_[pos]`.
>
> [3]{.pnum} _Throws_: Nothing.
>
> [4]{.pnum} [_Note 1_: Unlike `basic_string::operator[]`, `basic_string_view::operator[](size())` [has undefined behavior]{.rm}[violates a hardened precondition]{.add} instead of returning `charT()`. — `end note`]
...
>
> [7]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `!empty()`.
>
...
>
> [10]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `!empty()`.
>
...
>
> [1]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `n <= size()`.
>
...
>
> [3]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `n <= size()`.
>
...
>
:::add
> [_Note ?_: In most cases, the hardened precondition is equivalent to `!a.empty()`. — _end note_]
:::
...
>
::: add
> [73]{.pnum} _Hardened preconditions_: `std::prev(a.end())` is dereferenceable.
>
:::
...
>
::: add
> [118]{.pnum} _Hardened preconditions_: `a.begin() + n` is dereferenceable.
:::
...
:::add
> [_Note ?_: In most cases, the hardened precondition is equivalent to `n < a.size()`. — _end note_]
:::
...
> ```
> [9]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `!empty()`.
>
...
> ```
> [12]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `!empty()`.
>
...
> ```
> [30]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `pos` is valid.
>
...
> ```
> [33]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `pos` is valid.
>
...
>
> [1]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `*this` contains a value.
>
...
> `constexpr T& operator*() & noexcept;`
>
> [4]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `*this` contains a value.
>
...
> `constexpr const T&& operator*() const && noexcept;`
>
> [7]{.pnum} _[Hardened]{.add} [P]{.rm}[p]{.add}reconditions_: `*this` contains a value.
>
...
Modify [version.syn]{.sref} as indicated:
