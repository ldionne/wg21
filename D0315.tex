...
\begin{enumerate}
  ...
  \item \label{discussion.template}
    ...
    per \textbf{[temp.over.link] 14.5.6.1/4}:
    \begin{quote}
...
\end{codeblock}
  ...
  \item \label{wording.template} \hyperref[discussion.template]{(discussion)}
    ...
    \begin{quote}
      ...
      parameters are never considered equivalent, and two lambda-expressions
      involving within their bodies template parameters are never considered
