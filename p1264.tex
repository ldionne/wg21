...
throw \texttt{ios_base::failure} (27.5.5.4),}{\texttt{ios_base::failbit} is
turned on in the input function's \textit{local error state} before
...
which may throw \texttt{ios_base::failure} (27.5.5.4)}{\texttt{ios_base::failbit} is turned
on in the input function’s \textit{local error state} before \texttt{setstate} is called}.
\end{quote}
