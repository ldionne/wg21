...
\begin{quote}
  ...
  \added{The closure type for a \textit{lambda-expression} has a defaulted
    default constructor, a defaulted copy assignment operator, and a defaulted
    move assignment operator, if and only if the \textit{lambda-expression}
    does not have a \textit{lambda-capture}.}
